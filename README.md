...
1. Press the "Use this template" button at the top of this repo to create a new repo with the contents of this octane-doctor.
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/octane-doctor.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/octane-doctor)
...
```bash
php artisan vendor:publish --tag="octane-doctor-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="octane-doctor-views"
```
